            ...
            >
               ...
               <div>
                  ...
                  <input
                     ...
                     required={true}
                     className='w-full border rounded border-gray-300 text-gray-700 px-3 py-2 focus:outline-2 focus:outline-indigo-400'
                  />
               </div>
               ...
               <button
                  type='submit'
                  disabled={loading}
                  className='w-full bg-indigo-600 p-2 rounded-md text-white transition-colors duration-200'
               >

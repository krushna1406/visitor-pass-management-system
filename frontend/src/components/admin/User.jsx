...
const User = ({ user }) => {
   ...
   return (
      <div className='grid grid-cols-[0.4fr_1.2fr_1.7fr_0.8fr_0.7fr_0.2fr] gap-2 mx-2 bg-white my-2 py-2 px-4 rounded-md text-gray-600 shadow-sm shadow-gray-200'>
